### makefile automatically created by makenek 12/17/2015 09:50:25 ###
BINNAME=nek5000
LIBNAME=libnek5000.a
CASENAME:=cavity
CASEDIR:=/scratch/nof/phd/parallel_amg_setup/cavity
S:=/lscratch/nof/phd/parallel_amg_setup/Nek5000
S2:=/lscratch/nof/phd/parallel_amg_setup/Nek5000/cmt
J:=$S/jl
OPT_INCDIR:=./
OBJDIR=obj
IFMPI:=true
...
# JL CRS GRID SOLVER
ifeq ($(IFAMG),true)
CGS := $(JO)amg_tools.o $(JO)amg_setup.o $(JO)amg.o $(JO)fcrs.o
else
...
$(OBJDIR)/$(JO)amg_tools.o       :$(J)/amg_tools.c;       $(CC) -c $(cFL2) $(JL) $< -o $@
$(OBJDIR)/$(JO)amg_setup.o       :$(J)/amg_setup.c;       $(CC) -c $(cFL2) $(JL) $< -o $@
